      ...
      <section className="py-12 bg-gray-100">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-8 text-gray-90 font-freeman">Our Educational Philosophy</h2>
            ...
            <h2 className="text-3xl font-bold mb-8 text-gray-90 font-freeman">Enroll in Our Academic Programs</h2>
            <p className="text-lg text-gray-700 mb-8 font-merriweather">
            ...
            <Link href="/admission" className="bg-blue-500 text-white py-3 px-6 rounded-full shadow-md hover:bg-blue-600 transition duration-300 font-freeman">Enroll Now</Link>
          </div>
        </div>
      </section>
    );
