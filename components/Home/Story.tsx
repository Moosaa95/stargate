        ...
        >
            ...
            >
                ...
                <div className="md:w-1/2">
                    <h2 className="sm:text-[1.875rem] text-[1.5rem] font-bold text-gray-90 mb-5 leading-tight font-freeman">Our Foundation: A Beacon of Learning and Integrity</h2>
                    <p className="text-gray-700 text-lg leading-7 mb-7 font-merriweather">
            ...
            >
                <div className="md:w-1/2">
                    <h2 className="sm:text-[1.875rem] text-[1.5rem] font-bold text-gray-90 mb-5 leading-tight font-freeman">Our Growth: A Story of Achievement and Community</h2>
                    <p className="text-gray-700 text-lg leading-7 mb-7">
                        <span className="font-bold text-gray-90 font-merriweather">Expanding Horizons:</span> From our initial two students, Stargate Academy has grown significantly, now
