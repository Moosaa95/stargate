    ...
    <section className="bg-gradient-to-b from-blue-200 to-blue-300 py-16 mb-10">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-8 text-gray-800 font-freeman">Join Us on This Journey</h2>
          <p className="text-lg text-gray-800 mb-8 font-merriweather">
          ...
          <div className="flex justify-center mb-8">
            <Link href="/admission" className="bg-gray-90 text-white py-2  font-freeman px-6 rounded-full shadow-md hover:bg-blue-600 transition duration-300 ease-in-out">Apply Now</Link>
          </div>
          <p className="text-lg text-gray-800 mb-8 font-merriweather">
          ...
          <p className="text-lg text-gray-800 font-merriweather">
